...
class User(AbstractUser):
    ...
    image = models.ImageField(null=True, max_length=10000, default='', blank=True)

    REQUIRED_FIELDS = ['email', 'first_name', 'last_name', 'phone_number', 'street_address', 'district', 'division', 'is_staff', 'image']
    # REQUIRED_FIELDS = ['email', 'first_name', 'last_name', 'phone_number', 'street_address', 'district', 'division', 'is_staff']
